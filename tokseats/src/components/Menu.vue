    ...
    <div>
      ...
      <v-row class="my-4" justify="center">
        ...
        >
          ...
          <v-card-actions>
            <v-btn text color="primary" @click="addToCart(meal)"
              >Add to Cart</v-btn
            >
          </v-card-actions>
        </v-card>
      ...
      <v-row class="my-4" justify="center">
        ...
        >
          ...
          <v-card-actions>
            <v-btn text color="primary" @click="addToCart(single)"
              >Add to Cart</v-btn
            >
          </v-card-actions>
        </v-card>
      ...
      <v-row class="my-4" justify="center">
        ...
        >
          ...
          <v-card-actions>
            <v-btn text color="primary" @click="addToCart(side)"
              >Add to Cart</v-btn
            >
          </v-card-actions>
        </v-card>
      ...
      <v-row class="my-4" justify="center">
        ...
        >
          ...
          <v-card-actions>
            <v-btn text color="primary" @click="addToCart(drink)"
              >Add to Cart</v-btn
            >
          </v-card-actions>
        </v-card>
